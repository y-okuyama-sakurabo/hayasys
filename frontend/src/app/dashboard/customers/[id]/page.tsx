...
export default function CustomerDetailPage() {
  ...
  const tab =
    (searchParams.get("tab") as CustomerTab) ?? "basic";
  ...
  return (
    <Box p={3}>
      ...
      <Stack direction="row" spacing={2} mb={3}>
        <Button
          variant={tab === "basic" ? "contained" : "outlined"}
          onClick={() => goTab("basic")}
        >
          基本情報
        </Button>
        <Button
          ...
          onClick={() => goTab("vehicles")}
        >
          所有車両
        </Button>
        <Button
          variant={tab === "schedules" ? "contained" : "outlined"}
          onClick={() => goTab("schedules")}
        >
          スケジュール
        </Button>
        <Button
          variant={tab === "communications" ? "contained" : "outlined"}
          onClick={() => goTab("communications")}
        >
          業務連絡
        </Button>
      </Stack>
