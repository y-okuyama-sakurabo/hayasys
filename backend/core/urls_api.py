...
from core.views.vehicles.views import (
    ...
    CustomerVehicleAllListAPIView,
    CustomerVehicleReleaseAPIView,
    CustomerVehicleSearchAPIView,
)
...
from core.views.orders.order_mark_sales_view import OrderMarkSalesAPIView
...
urlpatterns = [
    ...
    path("customers/<int:customer_id>/schedules/", CustomerScheduleListCreateAPIView.as_view(),
    ...
    path("estimates/next-no/", EstimateNextNoAPIView.as_view(), name="estimate-next-no"),  # ✅ 新規追加
    ...
    "orders/prepare-from-estimate/",
        PrepareOrderFromEstimateAPIView.as_view(),
        name="order-prepare-from-estimate"
    ),
    ...
    path("delivery-payment-management/",
         DeliveryPaymentManagementListAPIView.as_view(),
         name="delivery-payment-management-list"),
    ...
    path("orders/<int:order_id>/mark-sales/", OrderMarkSalesAPIView.as_view()),
